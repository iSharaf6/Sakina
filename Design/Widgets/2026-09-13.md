...
## 17 September transparency correction

Replaced the three dedicated widget masters with existing transparent Haneen
artwork: the morning stretching cat, the lantern cat, and the Qur’an on its rehal.
The old white-background masters left enclosed white pockets behind the tail,
and the morning source itself was cropped at the left edge. The replacements
retain real PNG alpha and complete silhouettes; widget rendering now preserves
their alpha instead of applying the paper cutout. Countdown art stays within the
card inset, and compact artwork fits its allocated row with additional padding.

Source inspection confirms a clear border on all three replacement assets. The
asset regression test now requires actual source alpha and a transparent border,
not only one clear corner. Final simulator light/dark and RTL review is pending.
