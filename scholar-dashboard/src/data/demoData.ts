...
export const demoProfile: ScholarProfile = {
  userId: 'demo-scholar',
  displayNameEn: 'Dr. Abdullah Abu Hatab',
  displayNameAr: 'د. عبد الله أبو حطب',
  titleEn: '',
  titleAr: '',
  bioEn: '',
  bioAr: '',
  avatarPath: '',
  facebookUrl: 'https://facebook.com/Dr.AbdullahAbuHatab',
  instagramUrl: 'https://instagram.com/Dr.AbdullahAbuHatab',
  youtubeUrl: '',
  tiktokUrl: '',
  websiteUrl: '',
  verified: false,
